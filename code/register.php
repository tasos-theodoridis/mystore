...
<body class="text-center">
  ...
  <div class="container" id="content">
     <!-- den ginetai submit oi function ginontai include sthn selida sthn arxh  -->
     <form  method="POST" >
        ...
        <p>
          ...
          <input id="phone" name="phone" pattern=[0-9]{10} type="text" required>
        </p>

        
        <p>
          <button type="button" name="register" id="reg_btn">Create My Account</button>
        </p>
   ...
   $.ajax({
     ...
     success: function(response){
       if (response == 'taken' ) {
         ...
         $('#username').siblings("span").addClass("alert alert-success");
